...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="mojo-http2-package-") as temp:
        ...
        net_package = one_package(
            net_output, "mojo-net-0.2.0-*.conda", "mojo-net 0.2.0"
        )
        ...
        tls_package = one_package(
            tls_output, "mojo-tls-0.2.0-*.conda", "mojo-tls 0.2.0"
        )
        ...
        package = one_package(output, "mojo-http2-0.1.0-*.conda", "mojo-http2 0.1.0")
